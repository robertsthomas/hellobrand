...
export const briefExtractionResponseSchema = z.object({
  ...
  revisionRequirements: z.string().nullable().optional(),
  targetAudience: z.string().nullable().optional(),
  toneAndStyle: z.string().nullable().optional(),
  deliverablesSummary: z.string().nullable().optional(),
  deliverablePlatforms: z.array(z.string().trim().min(1)).default([]),
  creatorHandle: z.string().nullable().optional(),
  postingSchedule: z.string().nullable().optional(),
  agreementStartDate: z.string().nullable().optional(),
  agreementEndDate: z.string().nullable().optional(),
  executionTargetDate: z.string().nullable().optional(),
  conceptDueDate: z.string().nullable().optional(),
  campaignLiveDate: z.string().nullable().optional(),
  campaignFlight: z.string().nullable().optional(),
  draftDueDate: z.string().nullable().optional(),
  contentDueDate: z.string().nullable().optional(),
  postDuration: z.string().nullable().optional(),
  amplificationPeriod: z.string().nullable().optional(),
  usageNotes: z.string().nullable().optional(),
  disclosureRequirements: z.array(z.string().trim().min(1)).default([]),
  competitorRestrictions: z.array(z.string().trim().min(1)).default([]),
  linksAndAssets: z.array(z.string().trim().min(1)).default([]),
  promoCode: z.string().nullable().optional(),
  paymentNotes: z.string().nullable().optional(),
  paymentSchedule: z.string().nullable().optional(),
  paymentRequirements: z.string().nullable().optional(),
