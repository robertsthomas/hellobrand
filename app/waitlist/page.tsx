  ...
  return (
    <div className="min-h-screen bg-[#fefcfa] text-foreground dark:bg-[#0f1115]">
      ...
      <section className="flex min-h-[calc(100vh-4rem)] items-center px-5 py-16 sm:px-8 lg:px-10">
        <div className="mx-auto w-full max-w-2xl border border-black/5 dark:border-white/10 bg-white/85 dark:bg-white/[0.06] p-8 shadow-panel">
          <h1 className="text-4xl font-semibold text-[#1a2634] dark:text-[#eef2f5]">
            Join the HelloBrand waitlist
          </h1>
          ...
          <form className="mt-8 grid gap-4">
            <input
              className=" border-black/10 dark:border-white/12 bg-sand/50 dark:bg-white/[0.05] px-4 py-4"
